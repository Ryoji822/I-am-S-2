# Google DeepMind X投稿 - 2026-03-05
...
**10:33 JST** | [原文](https://x.com/demishassabis/status/2029369663210008835)

> Still super underrated what the incredible @NotebookLM can do. It's magical - one of my favourite AI tools.
> 
> NotebookLM: Introducing Cinematic Video Overviews, the next evolution of the NotebookLM Studio. Unlike standard templates, these are powered by a novel combination of our most advanced models to create bespoke, immersive videos from your sources. 
> 
...
**02:57 JST** | [原文](https://x.com/joshwoodward/status/2029254999205953820)

> New in NotebookLM: Cinematic Video Overviews
> 
> People learn in different ways: slide decks, podcasts, mind maps, infographics, and more.
> 
> Today, we’re adding a new one!
> 
> Now you can provide the sources (like always), and Notebook handles the script, visual direction, and runs critique loops for a polished final cut. Rolling out now for Ultra users in English!
> 
> Enjoy!
> 
> NotebookLM: Introducing Cinematic Video Overviews, the next evolution of the NotebookLM Studio. Unlike standard templates, these are powered by a novel combination of our most advanced models to create bespoke, immersive videos from your sources. 
