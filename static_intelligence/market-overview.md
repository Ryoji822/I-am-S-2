...
> 最終判断更新: 2026-06-21
> 全体確信度: 中
> 情報非対称性: ByteDance/DeepSeek グローバルシェア追跡困難。2nd tier不在。Y軸「フロンティア差別化の持続性」の完全な定量評価基準は未設定。H-GOV-001/(002)分割実行済み。(a)Anthropic固有政府介入56% medium・(b)業界全体萎縮効果はH-GOV-002 21% low。H-OAI-001 49% medium（ペナルティ停止）。SCN-002(30%)がSCN-004(30%)と同率首位。H-BTD-002操作化再定義実行済み。H-CAR-002ステートメント修正実行済み。IND-030 critical到達（Operation Epic Fury 96h/2,000標的・ミナブ168人死亡・全体600-1,400+民間人死亡・Gillibrand法案・DeepMind AI Control Roadmap）。品質チェックPASS
...
## プレイヤー一覧スナップショット (2026-06-21時点)

| 企業 | 主力モデル/製品 | 資金規模 | BenchLM | 直近の動向 |
|---|---|:-:|:-:|---|
| Anthropic | Claude Fable 5, Mythos 5, Opus 4.7, Claude Code | ARR $470億 [INFO-011](../Information/2026-06-19/collected-raw.md#INFO-011)(C-2)・ほぼ$1T評価額 | FrontierCode首位 | 判事Rita Lin「違法な報復」判断で連邦禁止阻止 [INFO-046](../Information/2026-06-21/collected-raw.md#INFO-046)(A-2)。Fable 5/Mythos 5アクセス停止中。輸出管理指令全容判明 [INFO-054](../Information/2026-06-21/collected-raw.md#INFO-054)(A-1)。秋IPO予定。H-ANT-001 37% low・H-ANT-002 64% medium・H-GOV-001 56% medium |
| OpenAI | GPT-5.5, Codex, Skills Beta | Q1収益$5.7B(3倍成長) [INFO-045](../Information/2026-06-21/collected-raw.md#INFO-045)(C-2)・IPO評価額最大$1T [INFO-050](../Information/2026-06-21/collected-raw.md#INFO-050)(B-2) | ARC-AGI 2首位(85%) | ChatGPTシェア初の50%割れ [INFO-054](../Information/2026-06-21/collected-raw.md#INFO-054)。Pentagon GenAI.mil 300万人。IPO Q4 2026目標。H-OAI-001 49% medium（ペナルティ停止） |
| Google | Gemini 3.5 Flash, Omni, Spark, DiffusionGemma | Cloud $4,600億バックログ・63%成長 | LMArena Elo首位 | DeepMind AI Control Roadmap [INFO-048](../Information/2026-06-21/collected-raw.md#INFO-048)(A-1)。安全チーム離職続出 [INFO-052](../Information/2026-06-21/collected-raw.md#INFO-052)(B-2)。NSF AI資金3分の1削減。H-GOO-001 49% low・H-GOO-003 48% medium |
| SpaceXAI | Grok 4.3, Grok Build, Grok Gov Model | $20B調達・Cursor $60B買収 | 4位 | Grok Gov Model Operation Epic Fury 96h/2,000標的 [INFO-044](../Information/2026-06-21/collected-raw.md#INFO-044)(A-2)。DoD CDAO宣誓陳述書「独自機能」 [INFO-053](../Information/2026-06-21/collected-raw.md#INFO-053)(A-1)。Gillibrand法案。H-XAI-002 59% medium・H-XAI-004 55% medium |
| ByteDance | 豆包2.0, Coze 3.0, Seedance 2.0 mini | CAPEX 2000億元 | 非公開 | Seedance 2.0 mini品質A-2 [INFO-042](../Information/2026-06-21/collected-raw.md#INFO-042)。DAU 2億超・Freemium+ECシナジーモデル（EC収益化81.1%）。H-BTD-001 64% medium・H-BTD-002 44% low |

---

## 0. 一文要約

SCN-002「技術は開くが勝者は出る」が30%に上昇しSCN-004「誰でもAI」と同率首位になった [scenarios.json](../config/scenarios.json)。SCN-003「静かな囲い込み」が24%から23%に低下した（-1%）。標準化加速が围い込み価値を更に侵食した。但し本根拠（標準化加速による围い込み価値侵食）での最終適用を宣言した。次回SCN-003調整には異なる根拠または証拠品質が必要。

本ラウンドの最大の構造的変化は [IND-030](../config/indicators.json) のhigh→critical移行である。Operation Epic FuryでGrok Gov Modelが96時間以内に2,000標的に2,000発を展開したことがA-2品質で文書化され [INFO-044](../Information/2026-06-21/collected-raw.md#INFO-044)、ミナブ小学校攻撃で168人 [INFO-043](../Information/2026-06-21/collected-raw.md#INFO-043)、全体で600〜1,400人以上の民間人が死亡した [INFO-049](../Information/2026-06-21/collected-raw.md#INFO-049)。軍事AIが個別実験から構造的実践に相転移した初の事象だ。Gillibrand法案 [INFO-053](../Information/2026-06-21/collected-raw.md#INFO-053) とDeepMind AI Control Roadmap [INFO-048](../Information/2026-06-21/collected-raw.md#INFO-048) は、立法府と最先端開発者が最高警戒レベルで認識していることを示す。

[H-OAI-001](../config/hypotheses.json) は49% ±0%。19R連続 I>Cペナルティ機構を一時停止した。Q1収益$5.7B（3倍成長） [INFO-045](../Information/2026-06-21/collected-raw.md#INFO-045) が「Anthropic成功＝OpenAI劣位」ゼロサム仮定の妥当性を更く損なう。[H-GOV-001](../config/hypotheses.json) は58%から56%に-2%。判事Rita LinがAnthropic連邦禁止を「違法な報復」と判断した [INFO-046](../Information/2026-06-21/collected-raw.md#INFO-046) がI側初のA-2品質証拠。[H-ANT-002](../config/hypotheses.json) は65%から64%に-1%。Fable 5/Mythos 5アクセス停止の開発者影響。
...
| [H-GOV-001](../config/hypotheses.json) | 政府がAnthropicの安全性姿勢に圧力をかける先例が確立された | 56% medium | -2%（58→56%）。判事Rita Lin「違法な報復」判断(INFO-046 A-2)がI側初のA-2品質証拠。C=10件蓄積は健在。輸出管理指令全容(INFO-054 A-1)。56%はC蓄積強さ反映＋司法逆圧＋上訴可能性織込み | [INFO-046](../Information/2026-06-21/collected-raw.md#INFO-046) [INFO-054](../Information/2026-06-21/collected-raw.md#INFO-054) [INFO-002](../Information/2026-06-14/collected-raw.md#INFO-002) [INFO-023](../Information/2026-06-12/collected-raw.md#INFO-023) | [INFO-046](../Information/2026-06-21/collected-raw.md#INFO-046) |
...
| [H-BTD-002](../config/hypotheses.json) | ByteDanceは豆包でFreemium + ECシナジーモデルを維持し、低価格（無料層）でのユーザー獲得からEC・広告・抖音シナジーを通じたクロス収益化で競争優位を維持する | 44% low | ±0%。操作化再定義実行（v4.11期限遵守）。EC収益化81.1%（INFO-013 B-2）はI誤分類からC証拠へ再分類。DAU 2億超の無料層獲得→EC・広告・抖音クロス収益化が低価格戦略の核心メカニズム。日収入<$140K vs 日コスト数千万元の構造的ギャップはgenuine Iとして残存 | (Freemium+ECシナジー維持) | [INFO-013](../Information/2026-06-20/collected-raw.md#INFO-013) [INFO-108](../Information/2026-06-20/collected-raw.md#INFO-108) |
...
| [H-CAR-002](../config/hypotheses.json) | AIコーディングツール普及で「書く能力」の価値が変容し（直接実装から設計・評価・方向付けへの移行）、「設計・評価・方向付けする能力」の価値が上昇する | 70% medium | ±0%。ステートメント修正実行（価値低下→価値変容・2R先送り解消）。AIコーディング$9.8-11B・51%コミットAI支援。METR 43%本番破損・ALE完遂<5%が上限制約として継続機能 | [INFO-034](../Information/2026-06-12/collected-raw.md#INFO-034) | (METR 43%本番破損) |
...
|---|---|---|---|:-:|
| [IND-013](../config/indicators.json) | セキュリティ侵害頻度 | 大規模インシデントで critical | OpenBSD 27年脆弱性AI発見・GitHub月9件障害・MCP Gateway中央集権化。新規A-2実被害なし。high/rising | 2026-06-20 |
| [IND-025](../config/indicators.json) | マルチモーダル信頼性・性能コモディティ化 | 性能差ベンダー間5%未満で high | Gemini 3.1 Pro動画推論55.63%・ARC-AGI-3全フロンティア0.37%。量的向上継続・真の理解未解決。elevated/stable | 2026-06-20 |
| [IND-026](../config/indicators.json) | エージェント本番環境到達率 | 3+独立ソースが<10%本番到達で high | ALE完遂<5%・95%失敗・96%ROI vs 74%ロールバック矛盾。期待-実態ギャップ構造的パターン化確定。high/rising | 2026-06-20 |
| [IND-027](../config/indicators.json) | MCP等オープンスタンダードの業界採用率 | 全主要プレイヤー採用で high | MCP月間1.1億DL・AAIF 170社・OpenShell OSS。標準化爆発的加速・围い込み同時進行。high/rising | 2026-06-20 |
| [IND-028](../config/indicators.json) | AGI到達度（客観ベンチマーク vs 主観宣言） | 主観-客観乖離拡大で high | DeepMind AGI 2029-2030・ARC-AGI-3 0.37%・LeCun退社AMI Labs。RSI具体化と客観ベンチマーク限界の同時進行。high/rising | 2026-06-20 |
| [IND-029](../config/indicators.json) | AIインフラ資本投入 vs 物理制約 | 資本流入が物理制約を上回り続ける限り high | Dallas Fed $3-5T・ByteDance 2000億元・Q1 $3000億・Anthropic $650億。資本流入加速・物理的制約ギャップ確定的。high/rising | 2026-06-20 |
| [IND-030](../config/indicators.json) | AI能力-リスク二面性 | （critical到達済み） | **critical/rising**。Operation Epic Fury 96h/2,000標的/2,000発(A-2)・ミナブ小学校168人死亡(B-2)・全体600-1,400+民間人死亡(B-2)・DoD CDAO宣誓陳述書「独自機能」(A-1)・Gillibrand法案・DeepMind AI Control Roadmap(A-1)。条件1+3充足・条件2（A-2技術的安全事故）未到達。判事Rita Lin「違法な報復」(A-2)は緩和要因 | 2026-06-21 |
