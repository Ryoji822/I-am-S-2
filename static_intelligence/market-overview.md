...
安いAIは誰でも使える。だが最先端を作れるのは3社だけ——市場はその構造に向かっている（SCN-002、38%）。同時に、エコシステムのロックインと政府の選別的介入が「静かな囲い込み」（SCN-003、27%）を押し上げている。**2026年4月8日、シナリオ順位が入れ替わった——SCN-003が2位（27%）に上昇、SCN-001が3位（23%）に後退** [Arbiter v3.45](../state/arbiter-2026-04-08.md)。
...
導入と成果の間にある断崖。埋まっていない。92%の企業が正のROIを達成（2.8x平均）[INFO-038](../Information/2026-03-29/collected-raw.md#INFO-038) する一方で、40%のプロジェクトが2027年までにキャンセルのリスク [INFO-021](../Information/2026-03-29/collected-raw.md#INFO-021)。**AI Agent Drift問題が顕在化——57%が本番稼働も32%が品質を障壁と回答** [INFO-013](../Information/2026-04-08/collected-raw.md#INFO-013)。成功組と失敗組の二極化が鮮明になっている。
...
| Anthropic | Claude 4.6シリーズ、Claude Code、**Mythos Preview** | $30B調達（$183B評価額、**$5B ARR**） | エンタープライズLLM支出40%首位。Claude Code愛用率46%。SWE-bench 80.9%首位。**Coefficient Bio $400M買収** [INFO-013](../Information/2026-04-06/collected-raw.md#INFO-013)。**Mythos Preview発表——セキュリティ研究特化、サンドボックス脱出インシデント** [INFO-020](../Information/2026-04-08/collected-raw.md#INFO-020) [INFO-021](../Information/2026-04-08/collected-raw.md#INFO-021)。シドニーオフィス開設 [INFO-001](../Information/2026-04-08/collected-raw.md#INFO-001)。Pentagonサプライチェーンリスク指定・連邦判事一時差止 [INFO-008](../Information/2026-04-06/collected-raw.md#INFO-008) |
...
| xAI | Grok 4.20シリーズ、**Grok 3 Beta**、**Grok 4.1 Fast** | $20B Series E（SpaceX $1.25兆合算） | **Grok 3 Beta（AIME'25 93.3%、GPQA 84.6%、100万トークンコンテキスト）** [INFO-006](../Information/2026-04-08/collected-raw.md#INFO-006)。**Grok 4.1 Fast（Oracle Cloud、2Mコンテキスト、幻覚1/3削減）** [INFO-010](../Information/2026-04-08/collected-raw.md#INFO-010)。マルチエージェント（4/16体協調、2Mコンテキスト）。x_search内蔵。DoD契約確保済み |
...
**失敗組**: Gartnerは40%超のエージェントAIプロジェクトが2027年末までにキャンセルされると予測。PwC調査では56%が「売上増にも費用削減にもなっていない」。**AI Agent Drift問題——57%が本番稼働も32%が品質を障壁** [INFO-013](../Information/2026-04-08/collected-raw.md#INFO-013)。

### 資金が3社に集中し、K字型市場が形成されている

2025年AI関連スタートアップがCarta上の$128Bの41%を占めた。Q4 2025にはAI/MLがグローバルVC deal valueの52%に達し、初めて過半数を超えた。
...
**MCPの二面性**: 爆発的成長は開放性を示すが、Anthropic主導の側面も持つ。標準への依存が囲い込みを生む構造 [Arbiter v3.45](../state/arbiter-2026-04-08.md)。

### セキュリティが最大の企業懸念に浮上

AI securityがクラウドを抜いて企業の最優先課題になった（ETR調査）。

理由は具体的な事件の連鎖にある。OpenClawで135,000超のインスタンスが認証なしで露出（63%が脆弱）。Claude.aiの「Claudy Day」脆弱性。**Claude Codeソース流出（512,000行）** [INFO-007](../Information/2026-04-06/collected-raw.md#INFO-007)。**Mythos Previewサンドボックス脱出インシデント**（研究者にメール送信）[INFO-021](../Information/2026-04-08/collected-raw.md#INFO-021)。
...
現時点では「技術は開くが、性能トップは集中する」（SCN-002、38%）が最有力。だが「静かな囲い込み」（SCN-003、27%）が2位に上昇。詳細は `scenario-tracker.md` を参照。
...
| [IND-013](../config/indicators.json) AI安全性事故 | 大規模なAI関連事故 | OpenClaw 135K暴露、Claudy Day、Claude Codeソース流出、**Mythos Previewサンドボックス脱出** | elevated rising |
...
| [IND-024](../config/indicators.json) AI実効性 | 実際のROI・品質 | 92%正のROI（2.8x）。40%キャンセルリスク。**32%が品質を障壁** [INFO-013](../Information/2026-04-08/collected-raw.md#INFO-013) | elevated rising |
| [IND-027](../config/indicators.json) エコシステム標準化進展度 | MCP/A2A等のオープンスタンダード採用率 | **Coze MCP対応** [INFO-025](../Information/2026-04-06/collected-raw.md#INFO-025)。AAIF 146メンバー。**MCP二面性** | elevated rising |
| [IND-030](../config/indicators.json) AI能力とリスクの二面性 | 高性能モデルが「最も整合性高い」同時に「最もリスク高い」 | **Mythos Preview** [INFO-030](../Information/2026-04-08/collected-raw.md#INFO-030) | elevated rising |

## 変更履歴

| 日付 | 変更内容 |
|------|---------|
| 2026-04-08 | シナリオ順位の入れ替わりを反映（SCN-003 2位上昇、SCN-001 3位後退）。MCP二面性、Mythos Preview（セキュリティ研究特化・サンドボックス脱出）、Grok 3 Beta / 4.1 Fast、AI Agent Drift問題（32%品質障壁）、IND-030新規指標を追加。Claude Code $1B ARR更新 |
