...
| [H-GOO-002](../config/hypotheses.json) | 围い込み回避で開放維持 | 44% | AAIF/MCP統合 [INFO-032](../Information/2026-05-06/collected-raw.md#INFO-032) と Red Hat MCP Gateway [INFO-033](../Information/2026-05-08/collected-raw.md#INFO-033) が開放を支持。围い込み5件目I蓄積(1:Workspace無料围い込み・2:围い込み宣言・3:Gemini Enterprise統合スタック・4:Vertex→Gemini Enterprise移行・5:AI Search围い込み深化 [INFO-005](../Information/2026-05-12/collected-raw.md#INFO-005) A-3)。開放C証拠完全不在。Red指摘: 围い込みが業界トレンド(Google固有ではない)可能性。low帯 | [INFO-032](../Information/2026-05-06/collected-raw.md#INFO-032) [INFO-033](../Information/2026-05-08/collected-raw.md#INFO-033) | [INFO-076](../Information/2026-05-08/collected-raw.md#INFO-076) Workspace 围い込み |
...
|---|---|---|---|:-:|
| [IND-001](../config/indicators.json) | 主要ベンチマーク性能 | +5pt 以上/期で high | BenchLM 93 (3位)、MMMU-Pro 88.21% 首位、ARC-AGI-2 77.1%、BenchLM Gemini 3 Pro Deep Think 100% [INFO-040](../Information/2026-05-08/collected-raw.md#INFO-040) | 2026-05-12 |
| [IND-006](../config/indicators.json) | エージェントスタック競争 | elevated 維持で継続監視 | Gemini Enterprise Agent Platform [INFO-019](../Information/2026-05-08/collected-raw.md#INFO-019)。AAIF/MCP 統合 [INFO-032](../Information/2026-05-06/collected-raw.md#INFO-032) | 2026-05-12 |
| [IND-025](../config/indicators.json) | マルチモーダル信頼性 | elevated | Claude Design/Opus 4.7ビジュアルデザイン対応 [INFO-004](../Information/2026-05-12/collected-raw.md#INFO-004)。Sonnet 4.6 OSWorld大幅改善 [INFO-007](../Information/2026-05-12/collected-raw.md#INFO-007)。量的向上継続。「真の理解」検証未解決 | 2026-05-12 |
| [IND-027](../config/indicators.json) | エコシステム標準化進展 | high / rising | Azure排他性終了+OpenAI SDK provider-agnostic+157K OpenCode移行。標準化加速。Gemini Enterprise围い込み同時進行 | 2026-05-12 |
| [IND-030](../config/indicators.json) | AI 能力とリスクの二面性 | elevated / rising | Pentagon 7社契約選出+DeepMind union 98% [INFO-026](../Information/2026-05-11/collected-raw.md#INFO-026)+EU Act延期+中国裁判所+Sanders法案。規制二方向同時進行深化 | 2026-05-12 |
...
| [INFO-004](../Information/2026-05-12/collected-raw.md#INFO-004) | Claude Design(Anthropic・競合参照) |
| [INFO-007](../Information/2026-05-12/collected-raw.md#INFO-007) | Sonnet 4.6(Anthropic・競合参照) |
...
| [Arbiter v3.75](../state/arbiter-2026-05-12.md) | H-GOO-001/002/003 確度評価の完全根拠（本文から外出し） |
