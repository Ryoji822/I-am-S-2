...
- 本社: 米国テキサス州オースティン（SpaceX傘下）
- CEO: Elon Musk
- 主力製品: Grok 3シリーズ、Grok Business/Enterprise、Grok Voice Agent API
- 推定従業員数: 非公開
- 直近の資金調達: Series E $20B [INFO-005](../Information/2026-02-18/collected-raw.md#INFO-005)
...
### 強み
- SpaceX買収による物理世界統合ポテンシャル
- $20B調達による急速な開発加速
- X（Twitter）リアルタイムデータアクセス
- Elon MuskのTesla/Neuralinkとの連携可能性

### 弱み
- 製品レベルでのSpaceX統合未確認
- エンタープライズ市場での後発性
- ベンチマーク性能でのOpenAI/Anthropic劣位
- 規制・コンプライアンス懸念

### 機会
- Tesla OptimusへのGrok統合
- SpaceX衛星通信とのAI連携
- ロボティクス・自動運転分野参入

### 脅威
- OpenAI Frontierのエンタープライズ独占
- Claude/MCP標準化への対抗策不在
- X利用者減少によるデータ劣化
...
| 指標 | ステータス | 傾向 | 現在値 |
|------|-----------|------|--------|
| IND-003 資金集中 | high | approaching | Anthropic $30B + xAI $20B = $50Bが2社に集中 | [更新: 2026-02-19] elevated→high昇格
| IND-007 Tier2買収 | elevated | rising | Anthropic→Bun買収、SpaceX→xAI買収 |
