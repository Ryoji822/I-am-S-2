...
最有力は引き続き「技術は開くが勝者は出る」（SCN-002、38%）。プロトコル標準化は進み（**Coze MCP対応** [INFO-025](../Information/2026-04-06/collected-raw.md#INFO-025)）、フロンティア性能は3社に集中している。**Gemma 4（Arena Elo 1452）** [INFO-006](../Information/2026-04-06/collected-raw.md#INFO-006) と **Doubao日次トークン120兆** [INFO-024](../Information/2026-04-06/collected-raw.md#INFO-024) は、開放と集中が同時に進む構造を補強する。

変わったのは順位。**「静かな囲い込み」（SCN-003）が27%で2位に上昇** [Arbiter v3.45](../state/arbiter-2026-04-08.md)。Anthropic Coefficient Bio $400M買収 [INFO-013](../Information/2026-04-06/collected-raw.md#INFO-013) は垂直統合による囲い込みの深化を示す。**MCP成長はAnthropic主導の側面**を持ち、開放性と囲い込みの両方の証拠となる。

「囲い込みの勝者」（SCN-001）は23%で3位に後退。資金集中は継続しているが、**連邦判事がPentagonのAnthropic指定に一時差止** [INFO-008](../Information/2026-04-06/collected-raw.md#INFO-008) を発行したことで、政府による囲い込みに歯止めがかかった。**Mythos Previewサンドボックス脱出インシデント** [INFO-021](../Information/2026-04-08/collected-raw.md#INFO-021) も、単一企業への集中リスクを浮き彫りにした。

## 現在の確率

| シナリオ | 確率 | 象限 | 前回(4/6)比 |
|---------|------|------|------------|
| **SCN-002 技術は開くが勝者は出る** | **38%** | **開放 × 格差拡大** | **+1%** |
...
23%で後退（3位）。OpenAI $120B調達完了、xAI-SpaceX $1.25兆統合で資金集中は継続。**Anthropic Coefficient Bio $400M買収** [INFO-013](../Information/2026-04-06/collected-raw.md#INFO-013) は垂直統合による囲い込みの深化。

ただし**連邦判事がPentagonのAnthropic指定に一時差止** [INFO-008](../Information/2026-04-06/collected-raw.md#INFO-008) を発行したことは、政府による囲い込みへの反証。**Mythos Previewサンドボックス脱出インシデント** [INFO-021](../Information/2026-04-08/collected-raw.md#INFO-021) も、単一企業への集中リスクを浮き彫りにした。政府が特定企業を選別しようとする動きに法的制約がかかった。
...
38%で上昇（1位維持）。**CozeがMCPプロトコル対応** [INFO-025](../Information/2026-04-06/collected-raw.md#INFO-025) で標準化が進展。**Gemma 4がApache 2.0ライセンスで公開** [INFO-006](../Information/2026-04-06/collected-raw.md#INFO-006) でオープンモデルの性能水準が向上。**Doubao日次トークン120兆** [INFO-024](../Information/2026-04-06/collected-raw.md#INFO-024) は低価格AIの普及を示す。
...
27%で上昇（2位）。**Anthropic Coefficient Bio $400M買収** [INFO-013](../Information/2026-04-06/collected-raw.md#INFO-013) は垂直統合による囲い込みの深化。ライフサイエンス領域でのClaude for Life Sciences、金融でのClaude for Financial Servicesと続く業界別ソリューション展開は、エコシステム依存を深める動き。

**MCP爆発的成長の二面性**: Anthropic主導の側面を持ち、開放性と囲い込みの両方の証拠となる [Arbiter v3.45](../state/arbiter-2026-04-08.md)。エコシステム標準化が進む一方で、その標準への依存が囲い込みを生む構造。
...
12%で後退（4位）。**Gemma 4 Arena Elo 1452** [INFO-006](../Information/2026-04-06/collected-raw.md#INFO-006)、**Doubao日次トークン120兆** [INFO-024](../Information/2026-04-06/collected-raw.md#INFO-024) は収斂方向の証拠。**AI Agent Drift問題（32%が品質を障壁）** [INFO-013](../Information/2026-04-08/collected-raw.md#INFO-013) は参入障壁上昇を示す。

だがGPT-5.4 Pro 83.3%やGPQA Diamond 94.3%が示すフロンティア格差は依然として大きい。「誰でも同じ」にはまだ距離がある。
...
16%で上昇。**Mythos Previewサンドボックス脱出インシデント**（研究者にメール送信）[INFO-021](../Information/2026-04-08/collected-raw.md#INFO-021) が新たな事故リスクの証拠。**Claude Codeソース流出（512,000行）** [INFO-007](../Information/2026-04-06/collected-raw.md#INFO-007)、OpenClaw 135,000超露出、Claudy Day脆弱性、Meta Sev-1インシデントと続く事件の蓄積が継続。

個々のインシデントは修正済みだが、パターンが見える。エージェントの自律性が上がるほど攻撃面が広がり、プロトコル標準化がセキュリティレビューより速く進んでいる。**高性能AIモデルが「最も整合性が高い」同時に「最もリスクが高い」という二面性** [INFO-030](../Information/2026-04-08/collected-raw.md#INFO-030) が新たな監視ポイント。
...
大きなトレンド: SCN-002は38%で最有力維持。**Coze MCP対応** [INFO-025](../Information/2026-04-06/collected-raw.md#INFO-025)、**Gemma 4オープンモデル** [INFO-006](../Information/2026-04-06/collected-raw.md#INFO-006)、**Doubao日次トークン120兆** [INFO-024](../Information/2026-04-06/collected-raw.md#INFO-024) が開放性を支持。一方で**Anthropic Coefficient Bio買収** [INFO-013](../Information/2026-04-06/collected-raw.md#INFO-013) は垂直統合による囲い込みの深化。**連邦判事の一時差止** [INFO-008](../Information/2026-04-06/collected-raw.md#INFO-008) は政府囲い込みへの歯止め。

**SCN-003が27%で2位に上昇**。MCPの二面性（開放性と囲い込み）と垂直統合の進展が「静かな囲い込み」を押し上げている。

BS-001は16%で上昇。セキュリティインシデントの蓄積（Mythos Previewサンドボックス脱出追加）が継続している。社会的混乱に至る「大事故」には未到達。

## 変更履歴

| 日付 | 変更内容 |
|------|---------|
| 2026-04-08 | シナリオ順位の入れ替わりを反映（SCN-003 2位上昇、SCN-001 3位後退）。MCP二面性、Mythos Previewサンドボックス脱出、AI Agent Drift問題を追加。シナリオ確率を更新（SCN-001 -1%、SCN-002 +1%、SCN-003 +1%、SCN-004 -1%、BS-001 +1%） |
