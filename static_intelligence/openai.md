...
2026年4月23日、OpenAIは**GPT-5.5**を発表した [INFO-032](../Information/2026-04-24/collected-raw.md#INFO-032) [INFO-070](../Information/2026-04-24/collected-raw.md#INFO-070)。「実作業のための新しいクラスの知能」。API価格は**GPT-5.4の2倍**（$5/M入力・$30/M出力）。400Kコンテキストウィンドウ。Codexでのコンピューター使用・ブラウザ操作拡張。ChatGPT Images 2.0も同時発表。価格を2倍にするという判断は、性能への確信とエンタープライズ層での差別化確信の両方を示す。

これに先立つ一週間で、OpenAIはB2Bチャネルを一気に開いた。**Codex Labs**を発表し、OpenAIの専門家が直接企業に入るハンズオンワークショップを開始 [INFO-001](../Information/2026-04-22/collected-raw.md#INFO-001)。**GSI 7社**（Accenture、PwC、Capgemini、CGI、Cognizant、Infosys、TCS）と提携し、IT巨大企業のB2Bチャネル経由でエンタープライズ市場を獲得する新パターンを確立した [INFO-001](../Information/2026-04-22/collected-raw.md#INFO-001)。**Workspace Agents**は共有エージェント・Slack連携・定期タスク・Codex harnessでチーム全体のワークフロー自動化に進出 [INFO-021](../Information/2026-04-23/collected-raw.md#INFO-021) [INFO-022](../Information/2026-04-23/collected-raw.md#INFO-022)。Codex WAUが3M→4Mに急増（33%増）。
...
**GPT-Rosalind**でドメイン特化モデルに乗り出した。ライフサイエンス研究向け推論モデルでBixBench Pass@1 0.751——人間専門家の95%タイルを超えた [INFO-003](../Information/2026-04-19/collected-raw.md#INFO-003)。GPT-5.4-Cyberに続く2つ目のドメイン特化モデルで、汎用→垂直展開の戦略が形になりつつある。

## 基本情報

- **本社**: サンフランシスコ
- **CEO**: Sam Altman
- **主力製品**: ChatGPT、**GPT-5.5**（$5/$30、400K context・Thinking/Pro変種・コンピューター使用拡張）、GPT-5.4シリーズ（Pro/mini/nano）、Agents SDK、Frontierプラットフォーム、**Codex**（desktop control・browser・memory・90+ plugins・heartbeats・multi-terminal・SSH・画像生成）、**Codex Labs**（エンタープライズハンズオン）、**Workspace Agents**（共有エージェント・Slack連携・定期タスク・Codex harness）、Operator（CUA）、GPT-5.4-Cyber（サイバー防御特化）、**GPT-Rosalind**（ライフサイエンス特化）、ChatGPT Images 2.0
...
| 2026-04-23 | 30GW compute by 2030計画発表 | D-3 | [INFO-018](../Information/2026-04-23/collected-raw.md#INFO-018) |
...
#### エンタープライズ開発プラットフォームになる（H-OAI-001、確度63%）

Codexの包括的アップデートは「コーディングアシスタント」から「自律型エンタープライズ開発プラットフォーム」への質的転換を実証した。**Codex Labs + GSI 7社提携**はB2Bチャネルを開き [INFO-001](../Information/2026-04-22/collected-raw.md#INFO-001)、**Workspace Agents**はそのチャネルを通じて配布する製品を個人向けからチーム向けに変える [INFO-021](../Information/2026-04-23/collected-raw.md#INFO-021) [INFO-022](../Information/2026-04-23/collected-raw.md#INFO-022)。

**GPT-5.5**はこの転換を補強する。API価格2倍という判断は、性能への確信とエンタープライズ層での値ごねなさへの賭けだ [INFO-032](../Information/2026-04-24/collected-raw.md#INFO-032) [INFO-070](../Information/2026-04-24/collected-raw.md#INFO-070)。400KコンテキストでCodex上の長時間自律作業を支え、コンピューター使用・ブラウザ操作拡張でエージェントの行動範囲を広げる。200社の早期アクセスパートナーはGSIチャネルと重なる可能性が高い。
...
ただし**十分条件**（実際の市場シェアデータ・エンタープライス契約数）は依然として不完全。**Reset to Zero問題**——マルチステップワークフローが予告なく致命的に失敗する——はエンタープライズ信頼性の構造的課題として蓄積している [INFO-070](../Information/2026-04-22/collected-raw.md#INFO-070)。**Comment and Control**脆弱性がGitHub Copilot AgentのAPI鍵漏洩を確認——エージェントランタイムのセキュリティギャップは業界全体に及ぶ [INFO-008](../Information/2026-04-23/collected-raw.md#INFO-008)。フロリダ州AGがChatGPT/OpenAIに対し刑事調査を開始——FSU銃撃事件容疑者のChatGPT会話が背景 [INFO-008](../Information/2026-04-24/collected-raw.md#INFO-008)。確度は63% [Arbiter v3.59](../state/arbiter-2026-04-24.md)。
...
Codex価格をメッセージ単位→トークン使用量ベースに変更した点も逆方向の動き [INFO-034](../Information/2026-04-22/collected-raw.md#INFO-034)。Batch APIは50%価格カット。**GPT-5.5の価格2倍**は囲い込み仮説の両面を持つ——独自性能のプレミアム化（C）だが、価格乖離が顧客を競合に押しやる可能性もある。囲い込みシグナル（サンドボックス独自化・Codex desktop control・価格プレミアム）と開放性シグナル（MCP標準化・価格競争・7社マルチプラットフォームパートナー）が相殺している。
...
- **GPT-5.5**: 400K context・Thinking/Pro変種・コンピューター使用拡張・200社早期アクセス [INFO-032](../Information/2026-04-24/collected-raw.md#INFO-032) [INFO-070](../Information/2026-04-24/collected-raw.md#INFO-070)
...
- **Workspace Agents**（共有エージェント・Slack連携・定期タスク）でチーム向けワークフロー自動化に進出 [INFO-021](../Information/2026-04-23/collected-raw.md#INFO-021)
...
- Codex desktop controlが新たなセキュリティ攻撃表面を生む ([IND-013](../config/indicators.json)、high)。97%の企業が12ヶ月以内にAIエージェントインシデントを予期 [INFO-021](../Information/2026-04-22/collected-raw.md#INFO-021)。**Comment and Control**がCopilot AgentのAPI鍵漏洩を確認 [INFO-008](../Information/2026-04-23/collected-raw.md#INFO-008)
- 43%のAI生成コード変更が本番でデバッグ必要 [INFO-019](../Information/2026-04-19/collected-raw.md#INFO-019)
- GPT-5.5価格2倍が競合（Anthropic/Google/DeepSeek）に顧客を押しやるリスク

### 機会

- Anthropic SCR指定の間隙を突く政府市場（DoW契約・AWS提携）
- GSI 7社チャネルでエンタープライス営業力を借用 [INFO-001](../Information/2026-04-22/collected-raw.md#INFO-001)
- GPT-5.5の価格プレミアムが性能差の証明として機能する場合、エンタープライスでの差別化が強化される
...
- EU AI法全面執行（2026年8月）がコンプライアンスコストを増大 [INFO-040](../Information/2026-04-24/collected-raw.md#INFO-040)
- DeepSeek V3.2-ExpがGemini 2.5 Pro大部分ベンチマークで上回る——中位層の競争激化 [INFO-062](../Information/2026-04-24/collected-raw.md#INFO-062)
- Reset to Zero問題がエンタープライズ導入の信頼性障壁に [INFO-070](../Information/2026-04-22/collected-raw.md#INFO-070)
- フロリダ州AG刑事調査がAI企業責任の法的先例になる可能性 [INFO-008](../Information/2026-04-24/collected-raw.md#INFO-008)
...
| 指標 | 状態 | トレンド | 現在値 |
|------|------|---------|--------|
| [IND-001](../config/indicators.json) 性能の非連続ジャンプ | high | approaching | GPT-5.4 Pro ARC-AGI-2 83.3%、o3 87.5%。マルチモーダル暫定1位。**GPT-5.5で性能の質的向上確認** [INFO-032](../Information/2026-04-24/collected-raw.md#INFO-032)。90%閾値まで2.5pt |
...
| [IND-013](../config/indicators.json) セキュリティ侵害頻度 | high | rising | Codex desktop control新攻撃表面。97%企業インシデント予期。Reset to Zero問題。**Comment and Control**でCopilot Agent API鍵漏洩確認 [INFO-008](../Information/2026-04-23/collected-raw.md#INFO-008)。MCP RCE Critical全SDK影響 |
| [IND-026](../config/indicators.json) エージェント本番環境到達率 | elevated | rising | Workspace Agents + Codex Labs GSI 7社 + GPT-5.5 400K context。84%設定ミス [INFO-041](../Information/2026-04-24/collected-raw.md#INFO-041)。Klarna再採用 [INFO-047](../Information/2026-04-24/collected-raw.md#INFO-047)。Reset to Zero |

## 変更履歴（直近5件のみ。詳細は git log を参照）

| 日付 | 変更内容 |
|------|---------|
| 2026-04-24 | **GPT-5.5新モデルリリース**（$5/$30・400K context・Thinking/Pro変種・コンピューター使用拡張・ChatGPT Images 2.0）・フロリダ州AG刑事調査・DeepSeek V3.2-Exp>Gemini 2.5 Proを反映してエグゼクティブサマリー・基本情報・タイムライン・戦略方向性・SWOT・I&Wを書き直し |
| 2026-04-23 | Workspace Agents（共有エージェント・Slack連携・定期タスク・Codex harness）新製品発表・30GW compute by 2030計画・Comment and Control脆弱性（Copilot Agent API鍵漏洩）を反映して戦略方向性・SWOT・I&Wを書き直し |
| 2026-04-22 | Codex Labs + GSI 7社提携（B2Bチャネル質的転換）・WAU 3M→4M・Codex "for almost everything"90+ plugins・Agents SDK MCP統合・GPT-5.4 Proマルチモーダル暫定1位・GPT-5.4 mini/nano・$100/月プラン・Reset to Zero問題を反映して戦略方向性・基本情報・タイムライン・SWOTを書き直し |
| 2026-04-19 | GPT-Rosalind（ライフサイエンス特化）を新製品として追加。Codex大幅アップデート・Agents SDK詳細を反映 |
| 2026-04-17 | Codex App大幅アップデート・GPT-5.3-Codex 25hr連続稼働・7社サンドボックスパートナーを反映して全面書き直し |
