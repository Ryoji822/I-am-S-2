...
|---|---|:-:|---|---|---|
| [H-OAI-001](../config/hypotheses.json) | Agent機能でB2B支配的地位を確立する | 63% | 二重JV $110B・Codex 4M WAU・FedRAMPでC蓄積。$14B損失とLLMシェア27%のIも同数。C/I均衡が確度を中央付近に固定。確証バイアス警告発出 | [INFO-024](../Information/2026-05-06/collected-raw.md#INFO-024) [INFO-074](../Information/2026-05-08/collected-raw.md#INFO-074) [INFO-025](../Information/2026-05-08/collected-raw.md#INFO-025) | [INFO-048](../Information/2026-05-06/collected-raw.md#INFO-048) [INFO-028](../Information/2026-05-06/collected-raw.md#INFO-028) [INFO-052](../Information/2026-05-08/collected-raw.md#INFO-052) |
| [H-OAI-002](../config/hypotheses.json) | MCP開放エコシステム上にプロプライエタリ上位レイヤーを構築する | 50% | Skills/Codex独自規格は围い込みC。マルチクラウド展開+provider-agnostic SDK+OpenCode移行の6重I蓄積が下層開放を示し、上層围い込み有効性を構造的に制約。围い込み形態変化(技術的→契約的)の可能性認識 | [INFO-035](../Information/2026-05-08/collected-raw.md#INFO-035) | [INFO-003](../Information/2026-05-11/collected-raw.md#INFO-003) [INFO-017](../Information/2026-05-11/collected-raw.md#INFO-017) [INFO-015](../Information/2026-05-11/collected-raw.md#INFO-015) |
| [H-OAI-003](../config/hypotheses.json) | AGI/スーパーインテリジェンスを最優先目標とする(事実上棄却) | 1% | $122B調達・二重JV $110B・GPT-5.5価格2倍・広告テスト・FedRAMPの経営行動がすべて商業化に向いており、AGI研究優先を示す行動証拠がない。GPT-5.5 on AWS Bedrockは商業化I | (なし) | [INFO-055](../Information/2026-05-06/collected-raw.md#INFO-055) [INFO-074](../Information/2026-05-08/collected-raw.md#INFO-074) [INFO-003](../Information/2026-05-11/collected-raw.md#INFO-003) |

## 5. 監視指標

| 指標ID | 何を見るか | 閾値 | 現在値 | 最終確認 |
|---|---|---|---|:-:|
| [IND-001](../config/indicators.json) | 主要ベンチマーク性能の非連続ジャンプ | +5pt以上/期で high | BenchLM 92（3位）。ARC-AGI-2 83.3%。Terminal-Bench 82.7%。GPT-Realtime-2 Big Bench Audio 96.6% | 2026-05-11 |
| [IND-013](../config/indicators.json) | AIエージェント関連セキュリティ侵害頻度 | 大規模インシデントで critical | サードパーティブロック+Claude Codeバグは品質問題(Anthropic側)。新規大規模脆弱性なし。high水準 | 2026-05-11 |
| [IND-026](../config/indicators.json) | エージェント本番環境到達率 | 3+独立ソースが<10%本番到達で high | CEO 83%導入予定 vs CIO 25%監視可能。91%$300K+/時間ダウンタイム。期待-実態ギャップ拡大兆候。elevated | 2026-05-11 |
| [IND-027](../config/indicators.json) | MCP等オープンスタンダードの業界採用率 | 全主要プレイヤー採用で high | Azure排他性終了+OpenAI SDK provider-agnostic+157K OpenCode移行+Multi-framework多様化。標準化加速。high水準 | 2026-05-11 |
| [IND-029](../config/indicators.json) | AIインフラ資本投入 vs 物理制約 | 資本流入が物理制約を上回り続ける限り high | $122B調達。$100B JV。VC $2,672億(Q1 2026)。ByteDance 2,000億元。資本流入加速。high水準 | 2026-05-11 |

## 6. 変化履歴

| 日付 | 変更 | きっかけ | 過去 → 現在 |
|:-:|---|---|---|
| 2026-05-11 | §4 §5 更新(H-OAI-002 50%・IND値最新化) | [INFO-003](../Information/2026-05-11/collected-raw.md#INFO-003) [INFO-017](../Information/2026-05-11/collected-raw.md#INFO-017) [INFO-015](../Information/2026-05-11/collected-raw.md#INFO-015) | H-OAI-002 53→50%・IND-027 high水準反映 |
