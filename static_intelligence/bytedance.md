...
|:-:|---|---|:-:|---|
| 高 | Seedance 2.0 mini: 単秒生成コスト約50%削減・業界初4モダリティ同時入力(画像/動画/音声/テキスト)・AI製薬新会社10億ドル評価で分社 | フロンティアモデル新規リリース。Seedance 2.0の機能拡張。[H-BTD-001](../config/hypotheses.json) のC（製品力向上）。コスト50%削減はFreemiumモデルの収益構造改善に寄与しうる | A-2 | [INFO-042](../Information/2026-06-21/collected-raw.md#INFO-042) |
| 高 | 豆包DAU 2億超・日収入<100万元（主にEC手数料）vs 日コスト数千万元（API推算）。雅虎香港財経等複数ソース | Freemium + ECモデルの財務構造A-2品質確認。前回06-20のINFO-108(B-2)と同一事象だが品質格上げ。独立ソース5件以上 | A-2 | [INFO-041](../Information/2026-06-21/collected-raw.md#INFO-041) |
...
| [IND-030](../config/indicators.json) | AI能力とリスクの二面性（規制・政治リスク） | （critical到達済み） | **critical/rising**。対外投資規制7/1発効(INFO-036 A-1)。中国$295B国家計画(INFO-040)。Operation Epic Fury 96h/2,000標的で軍事AI相転移・全球IND-030 critical伝播。Seed人材流出年間約70名(INFO-032) | 2026-06-21 |

## 6. 変化履歴

| 日付 | 変更 | きっかけ | 過去 → 現在 |
|:-:|---|---|---|
| 2026-06-21 | ターゲット編集。[IND-030](../config/indicators.json) high→critical移行反映。Seedance 2.0 mini品質A-2 ([INFO-042](../Information/2026-06-21/collected-raw.md#INFO-042)）・豆包DAU 2億超/日収入<100万元の品質A-2格上げ ([INFO-041](../Information/2026-06-21/collected-raw.md#INFO-041)）を反映。仮説確度は全て±0%据え置き | [INFO-042](../Information/2026-06-21/collected-raw.md#INFO-042) [INFO-041](../Information/2026-06-21/collected-raw.md#INFO-041) [arbiter-2026-06-21](../state/arbiter-2026-06-21.md) | IND-030 high→critical・H-BTD-001 64%(±0%)・H-BTD-002 44%(±0%)・H-BTD-003 40%(±0%) |
| 2026-06-20 | [H-BTD-002](../config/hypotheses.json) 操作化再定義執行（「低価格戦略維持」→「Freemium + ECシナジーモデル維持」）。EC 81.1%収益化のI誤分類を是正（I→C）。INFO-108・INFO-013・INFO-109・INFO-110を反映して全面書き直し | [INFO-108](../Information/2026-06-20/collected-raw.md#INFO-108) [INFO-013](../Information/2026-06-20/collected-raw.md#INFO-013) [INFO-109](../Information/2026-06-20/collected-raw.md#INFO-109) [INFO-110](../Information/2026-06-20/collected-raw.md#INFO-110) | H-BTD-001 64%・H-BTD-002 46→44%・H-BTD-003 40% |
...
| [INFO-041](../Information/2026-06-21/collected-raw.md#INFO-041) | 豆包DAU 2億超・日収入<100万元 vs 日コスト数千万元・複数ソース品質A-2(A-2) |
